...
<body class="bg-gray-300">
    <div class="container">
        <h2 class="text-3xl font-bold text-center mb-5" style="margin-top: -40px;">Detail  Kalkulator Pertanian Jagung </h2>
...
<body class="bg-gray-300">
    <div class="container mx-auto my-3 p-8  rounded-lg" s>
