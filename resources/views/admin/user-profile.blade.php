            ...
            <div class="row gx-4">
                ...
                <div class="col-lg-4 col-md-6 my-sm-auto ms-sm-auto me-sm-0 mx-auto mt-3">
                    <div class="nav-wrapper position-relative end-0" style="display: flex; justify-content: flex-end;">
                        ...
                        <li class="nav-item">
                            <form action="{{ url('/logout') }}" method="POST" class="d-flex justify-content-end">
                                @csrf
                                @method('DELETE')
                                <button type="submit" class="btn btn-logout btn-md mt-3 mb-3" style="border: 1px solid red; color: red;">
                                    Keluar
                                </button>
                            </form>
